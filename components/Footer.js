        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Water Safety Tips</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Steward Login</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Admin Portal</a></li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-semibold">+234 800 WATER (92837)</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="font-semibold">Enugu State, Nigeria</p>
              </div>
            </div>
          </div>
        </div>
