    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          ...
          <a href="tel:+2348131849363" className="bg-white bg-opacity-20 hover:bg-opacity-30 text-black border border-white border-opacity-50 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-200 flex items-center space-x-2">
