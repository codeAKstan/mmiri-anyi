      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Stewards Management</h1>
              <p className="mt-2 text-gray-600">Manage water steward accounts and permissions</p>
            </div>
              ...
              <form onSubmit={handleCreateSteward} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-black px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[#BADAFB] text-black"
                  >
                    {departments.map(dept => (
                      <option key={dept} value={dept}>{dept}</option>
                    ))}
